...
class MazeSolver:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('rrbot/laser/scan', LaserScan, self.laserscan_callback)
        rospy.Subscriber('/turtle1/odom', Odometry, self.odom_callback)

        self.velPub = rospy.Publisher('/turtle1/cmd_vel', Twist, queue_size = 5)
